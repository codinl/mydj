...
<div class="pad_10">
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		...
		<tr> 
	      <th>开始时间 :</th>
	      <td><input type="text" name="start_time" class="input-text" id="start_time"></td>
	    </tr>
	    <tr> 
	      <th>结束时间 :</th>
	      <td><input type="text" name="end_time" class="input-text" id="end_time"></td>
	    </tr>
	    <tr> 
	      <th>合成概率 :</th>
	      <td><input type="text" name="property" class="input-text"  style="width:30px;"></td>
	    </tr>
	    <tr> 
	      <th>最多次数 :</th>
	      <td><input type="text" name="success_max" class="input-text" style="width:30px;"></td>
	    </tr>
   		<tr>
			<th>状态 :</th>
			<td>
