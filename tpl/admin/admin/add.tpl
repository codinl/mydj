...
<div class="pad_10">
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		<tr> 
	      <th width="80">帐号名称 :</th>
	      <td><input type="text" name="name" id="user_name" class="input-text"></td>
	    </tr>
	    <tr> 
	      <th>帐号密码 :</th>
	    ...
	    <tr>
	      <th>审核状态 :</th>
	      <td>
	      	<input type="radio" name="is_active" class="radio_style" value="1" checked="checked"> &nbsp;有效&nbsp;&nbsp;&nbsp;
	        <input type="radio" name="is_active" class="radio_style" value="0"> &nbsp;禁用
	      </td>
	    </tr>
	</table>
